...
def is_mel(name, email):
    ...
    >>> is_mel('MEL MELITROPOLSKI', 'mel@ubermelon.com')
    True

    >>> is_mel('Mel Melitpolski', 'mel@ubermelon')
    True
...
def most_and_least_common_type(treats):
    ...
    Edge cases sample tests:

    one type of food
    >>> most_and_least_common_type([{'type': 'ice-cream'}])
    ('ice-cream', 'ice-cream')
    ...
    empty object inside the list is given
    >>> most_and_least_common_type([{}])  
    ...
    two same food items are given
    >>> most_and_least_common_type([{'type': 'ice-cream'}, {'type':'ice-cream'}])
    ('ice-cream', 'ice-cream')


    most and least common treat types
    >>> most_and_least_common_type([{'type': 'ice-cream'}, {'type':'ice-cream'}, {'type':'ice-cream', 'type':'chips', 'type': 'candy', 'type': 'candy'}])
    ('ice-cream', 'candy')


    if one key is empty in least common treat
    >>> most_and_least_common_type([{'type': 'ice-cream'}, {'type':'ice-cream'}, {'type':'ice-cream', '':'chips', 'type': 'candy', 'type': 'candy'}])
    ('ice-cream', 'candy')


    if one key is empty in most common treats
    >>> most_and_least_common_type([{'type': 'ice-cream'}, {'type':'ice-cream'}, {'type':'', 'type':'chips', 'type': 'candy', 'type': 'candy'}])
    ('ice-cream', 'candy')
